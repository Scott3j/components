<script>
	...
	import { themes } from '$lib/stores/store';
						...
						{#each data[tab] as e}
							<div class={e.type}>
								...
								{:else if e.type === 'sysTop'}
									<div class="left">
										<img
											src="src/img/background/Windows/img0.jpg"
											class="device_img"
											alt=""
											height="72"
											width="110.5"
									...
									<div class="right">
										<div class="column">
											<img
												src="src/apps/settings/msft.svg"
												alt=""
												height="20"
												width="20"
											/>
										...
										<div
											class="column"
											on:click={() =>
												setTab('Windows Update')}
											on:keypress={() =>
												setTab('Windows Update')}
										>
											<img
												src="src/img/apps/settings/Windows Update.webp"
												alt=""
												height="20"
												width="20"
											/>
								...
								{:else if e.type === 'netTop'}
									<div>
										<img
											src="src/img/apps/settings/wifi.png"
											alt=""
											height="100"
											width="100"
										/>
											...
											{#each $themes as theme}
												<img
													class:selected={theme ===
														'Windows/img0'}
													src="src/img/background/{theme}.jpg"
													alt=""
													height="75"
													width="120"
												/>
								...
								{:else if e.type === 'updateTop'}
									<div class="left">
										<img
											src="src/img/apps/settings/update.png"
											height="90"
											width="90"
											alt=""
										/>
		...
		<nav class:navOpen>
			...
			<div class="nav_bottom">
				{#each Object.keys(data) as e}
					...
					>
						<img
							src="src/img/apps/settings/{e}.webp"
							alt=""
							height={16}
							width={16}
						/>
